...
vim.cmd([[
   let personal_wiki = {}
   let personal_wiki.path = '/media/adrs/WIKI/vimwiki/personal/' 
   ...
   let old_wiki = {}
   let old_wiki.path = '/media/adrs/WIKI/vimwiki/old-wiki/'
   ...
   let tech_wiki = {}
   let tech_wiki.path = '/media/adrs/WIKI/vimwiki/tech_docs/'
   ...
   let shopping_wiki = {}
   let shopping_wiki.path = '/media/adrs/WIKI/vimwiki/shopping_docs/'
   ...
   let g:vimwiki_list = [personal_wiki, old_wiki, tech_wiki, shopping_wiki, {'auto_diary_index': 1}]
